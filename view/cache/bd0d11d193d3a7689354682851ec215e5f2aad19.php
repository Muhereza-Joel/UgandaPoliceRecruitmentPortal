                  ...
                  <td>
                    <div class="dropdown">
                      ...
                      <div class="dropdown-menu" aria-labelledby="actionDropdown">
                        ...
                        <a href="/<?php echo e($appName); ?>/test/delete/" class="dropdown-item icon text-danger" id="remove-btn" data-test-id="<?php echo e($test['test_id']); ?>">
                          Delete Test
                        </a>
                        <?php endif; ?>
                      </div>
...
<script>
  $(document).ready(function() {
    ...
    $('#confirmDeleteModal').on('click', '#confirmDeleteBtn', function() {
      $.ajax({
        method: "POST",
        url: "/<?php echo e($appName); ?>/test/delete/",
        data: {
          id: testId
        },
        success: function(response) {
