          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="large fst-italic"><?php echo $userDetails['about']; ?></div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8"><?php echo e($userDetails['name']); ?></div>
                </div>
                <div class="row">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <input oninput="capitalizeEveryWord(this)" name="fullName" type="text" class="form-control" id="fullName" required placeholder="Enter your full name" value="<?php echo e($userDetails['name']); ?>">
