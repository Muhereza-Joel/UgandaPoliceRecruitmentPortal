    ...
    <section class="section dashboard">
        <div class="row">
            <div class="card mx-3" id="timer-card">
                <div class="card-body">
                    <span id="time" style="display: none;"><?php echo e($time); ?></span>
...
<script>
    $(document).ready(function() {
        ...
        function loadQuestions() {
            $.ajax({
                url: '/<?php echo e($appName); ?>/test/questions/?test_id=' + '<?php echo e($test_id); ?>&user_id=' + '<?php echo e($user_id); ?>',
                method: 'GET',
        ...
        function updateTimer() {
            ...
            if (totalTime <= 0) {
                ...
                window.location.href = '/<?php echo e($appName); ?>/exam/';
            }
            totalTime--;
        }
        ...
        function submitResponse(selectedOption) {
            $.ajax({
                url: '/<?php echo e($appName); ?>/responses/create/',
                method: 'POST',
                data: {
                    user_id: '<?php echo e($user_id); ?>', // Replace 'your_user_id' with the actual user ID
                    test_id: '<?php echo e($test_id); ?>', // Replace 'your_test_id' with the actual test ID
