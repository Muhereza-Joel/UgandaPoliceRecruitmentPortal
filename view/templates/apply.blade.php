    ...
    <section class="section dashboard">
        ...
        <div class="card py-4  px-2 my-3">
            <div class="card-body">
                ...
                <div class="alert alert-warning">Please click <a href="/{{$appName}}/auth/user/profile/">here</a> if you want to update your profile.</div>
                <div class="row my-2">
        ...
        <button class="btn btn-sm btn-primary" id="submit-application-btn" data-id="{{$job['id']}}">Submit Application</button>
