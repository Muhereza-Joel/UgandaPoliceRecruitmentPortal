    ...
    <div class="row">
      <div class="col-xl-4">
        <div class="text-center">
          ...
          <span class="text-info"><strong>Your Role : </strong> {{$role}}</span>
          <div>
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['about']}}</div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['name']}}</div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-light">NIN Number</div>
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['nin']}}</div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-light">Date of Birth</div>
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['dob']}}</div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-light">Gender</div>
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['gender']}}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-light">Company</div>
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['company']}}</div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-light">Job</div>
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['job']}}</div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-light">NIN Number</div>
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['nin']}}</div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['email']}}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-light">Country</div>
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['country']}}</div>
                </div>

                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-light">District</div>
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['district']}}</div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold text-light">Village</div>
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['village']}}</div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8 text-light">{{$userDetails['phone']}}</div>
                </div>
    ...
    $('#image').on('change', function() {
      ...
      $.ajax({
        ...
        success: function(response) {
          ...
          $('#image_url').val("http://localhost/{{$appName}}/uploads/images/" + response);
          $('#profile-photo').attr('src', "http://localhost/{{$appName}}/uploads/images/" + response);
