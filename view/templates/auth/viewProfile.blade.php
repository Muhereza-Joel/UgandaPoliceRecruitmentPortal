          ...
          <div class="card-body pt-3">
            ...
            <div class="tab-content pt-2">
              ...
              <div class="tab-pane fade show active profile-overview" id="profile-overview">
                ...
                <div class="large fst-italic">{!!$userDetails['about']!!}</div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8">{{$userDetails['nin']}}</div>
                </div>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-9 col-md-8">{{$userDetails['district']}}</div>
                </div>
                <div class="row">
                  <div class="col-lg-3 col-md-4 label fw-bold ">Village</div>
                  <div class="col-lg-9 col-md-8">{{$userDetails['village']}}</div>
                </div>
                  ...
                  <div class="card-body">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        ...
                        <input oninput="capitalizeEveryWord(this)" name="fullName" type="text" class="form-control" id="fullName" required placeholder="Enter your full name" value="{{$userDetails['name']}}">
