          ...
          <div class="container">
            <div class="row justify-content-center">
              <div class="col-xl-10 col-md-10 d-flex flex-column align-items-center justify-content-center">
                ...
                <p>Uganda plolice recruitment process requires that we know all our applicants better, Completing your profile helps us to capture your details earlier in the recruitment process. </p>
              </div>
              <hr class="w-75">
            </div>
                    ...
                    <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                      ...
                      <div class="row mb-3">
                        ...
                        <div class="col-md-12 col-lg-12 d-flex flex-column align-items-center justify-content-center">
                          ...
                          <img id="profile-photo" src="/{{$appName}}/assets/img/avatar.png" class="rounded-circle" alt="Profile" width="150px" height="150px" style="border: 3px solid #999;">
                          <div class="pt-2">
