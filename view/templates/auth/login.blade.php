                            ...
                            <div class="card-body">
                                ...
                                <form id="login-form" class="row g-3 needs-validation" novalidate>
                                    ...
                                    <div class="col-12">
                                        ...
                                        <p class="small mb-0">If you don't have account? <a href="/{{$appName}}/auth/register/">click here to</a> create an register</p>
                                    </div>
                                </form>
                    ...
                    <div class="col-lg-8" style="border-left: 1px solid #999;">
                        <div class="d-flex flex-column justify-content-center py-4">
                            <a href="/{{$appName}}" class="logo d-flex align-items-center w-auto">
                                ...
                                <br />
                                <span class="text-light">Uganda Police Force.</span>

                            </a>
                            <hr>
                        </div><!-- End Logo -->
                        <div class=" ps-4 mt-5">
                            <h4>Welcome to Uganda Police Force Recruitment Portal.</h4>

                            <h6>The mandate of Uganda Police Force as provided in the Constitution of the Republic of Uganda, and Uganda Police Force Act; i is protection of life and property, prevention and detection of crime, keeping law and order, and maintenance of overall Security and Public Safety in Uganda.</h6>
                            <hr>
